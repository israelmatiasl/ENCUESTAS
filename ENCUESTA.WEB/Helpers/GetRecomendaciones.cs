...
namespace ENCUESTA.WEB.Helpers
{
    public class GetRecomendaciones
    {
        ...
        public static List<String> BuildRecomendacionesPrincipales(List<String> totalrecomenadiones)
        {
            List<String> principales = new List<string>();
            String[] arrrecomprincipal = { "1", "4", "5", "6", "7", "8", "11", "13", "16", "19", "22", "23", "26", "27", "29", "31" };
            foreach (var recomend in totalrecomenadiones)
            {
                foreach (var x in arrrecomprincipal)
                {
                    if (recomend.Split('.')[0].Equals(x))
                    {
                        principales.Add(recomend);
                    }
                }
            }
            return principales;
        ...
        public static List<String> RecomendacionesPrincipales(List<String> principales)
        {
            List<String> final = new List<string>();
            foreach(var x in principales)
            {
                final.Add(x.Split('.')[1]);
            }
            return final;
        ...
        public static List<String> BuildRecomendacionesSecundarias(List<String> principales, List<String>totalrecomendaciones)
        {
            List<String> secundarias = new List<string>();
            secundarias = totalrecomendaciones.Except(principales).ToList();
            
            return secundarias;
        }

        public static List<String> RecomendacionesSecundarias(List<String> secundarias)
        {
            List<String> final = new List<string>();
            foreach(var x in secundarias)
            {
                final.Add(x.Split('.')[1]);
            }
            return final;
